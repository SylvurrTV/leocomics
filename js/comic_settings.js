...
const maxpg = 81; //the current number of pages your comic has in total. this DOESNT necessarily mean number of IMAGE FILES as it doesn't count pages split into multiple files.
...
},
{
    ...
    imageFiles: 1,
    authorNotes: `
    <p>Satan sitting there, she’s smiling, booping my nose more and more. Oh, no, no, please, God, help me!</p>
    `,
},
{
    pgNum: 58,
...
},
{
    ...
    imageFiles: 1,
    authorNotes: `
    <p>This is based on an actual dream St. Nick (allegedly) had where he was a detective, investigating the murder of three boys, and it turns out they were in a vat of pickled foods and (possibly) picked themselves... what a fun, wholesome Christmas fact :3<p>
    `,
},
{
    pgNum: 66,
 ...
 },
{
    ...
    imageFiles: 1,
    authorNotes: `
    <p>Shrimp, if ur seeing this… hai frend!! ^_^<p>
    `,
},   
{
    pgNum: 68,
    ...
    imageFiles: 1,
    authorNotes: `
    <p>idk what to make the description… nya o.o<p>
    `,
 },   
 {
    pgNum: 69,
 ...
 },   
 {
    pgNum: 81,
    title: `Wedding Dress`,
    date: writeDate(2026, 8, 7),
    altText: "Wedding Dress",
    imageFiles: 1,
    authorNotes: `
    <p>There is nothing quite like the joy of wearing a super poofy wedding dress... I think lol idk ^^<p>
    `, 
 }
];
